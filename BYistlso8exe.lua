...
-- GUI для скриптов
local ScriptsGui = Instance.new("Frame")
ScriptsGui.Name = "ScriptsGui"
ScriptsGui.Parent = ExecutorGui
ScriptsGui.BackgroundColor3 = Color3.fromRGB(25, 35, 55)
ScriptsGui.BorderSizePixel = 0
ScriptsGui.Position = UDim2.new(0.5, -175, 0.5, -125)
ScriptsGui.Size = UDim2.new(0, 350, 0, 250)
ScriptsGui.Visible = false
ScriptsGui.Active = true
ScriptsGui.Draggable = true
local ScriptsGradient = Instance.new("UIGradient")
ScriptsGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(25, 35, 55)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(45, 65, 85))
})
ScriptsGradient.Rotation = 90
ScriptsGradient.Parent = ScriptsGui
local ScriptsCorner = Instance.new("UICorner")
ScriptsCorner.CornerRadius = UDim.new(0, 15)
ScriptsCorner.Parent = ScriptsGui

local ScriptsTitle = Instance.new("TextLabel")
ScriptsTitle.Name = "ScriptsTitle"
ScriptsTitle.Parent = ScriptsGui
...
ScriptsTitle.TextStrokeTransparency = 0.6

local ScriptsCloseButton = Instance.new("TextButton")
ScriptsCloseButton.Name = "ScriptsCloseButton"
ScriptsCloseButton.Parent = ScriptsGui
ScriptsCloseButton.BackgroundColor3 = Color3.fromRGB(150, 50, 50)
ScriptsCloseButton.Position = UDim2.new(0.9, -35, 0.05, 0)
ScriptsCloseButton.Size = UDim2.new(0, 25, 0, 25)
ScriptsCloseButton.Font = Enum.Font.GothamBold
ScriptsCloseButton.Text = "X"
ScriptsCloseButton.TextColor3 = Color3.fromRGB(255, 255, 255)
ScriptsCloseButton.TextSize = 16
local ScriptsCloseCorner = Instance.new("UICorner")
ScriptsCloseCorner.CornerRadius = UDim.new(0, 8)
ScriptsCloseCorner.Parent = ScriptsCloseButton

-- Кнопки скриптов
local WallhackButton = Instance.new("TextButton")
WallhackButton.Name = "WallhackButton"
WallhackButton.Parent = ScriptsGui
WallhackButton.Position = UDim2.new(0.1, 0, 0.2, 0)
WallhackButton.Size = UDim2.new(0.3, 0, 0, 40)
...
local WallhackGradient = Instance.new("UIGradient")
WallhackGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 150, 200)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 100, 150))
})
WallhackGradient.Parent = WallhackButton
local WallhackCorner = Instance.new("UICorner")
WallhackCorner.CornerRadius = UDim.new(0, 10)
WallhackCorner.Parent = WallhackButton

local SpeedButton = Instance.new("TextButton")
SpeedButton.Name = "SpeedButton"
SpeedButton.Parent = ScriptsGui
SpeedButton.Position = UDim2.new(0.5, 0, 0.2, 0)
SpeedButton.Size = UDim2.new(0.3, 0, 0, 40)
...
JumpButton.Parent = ScriptsGui
JumpButton.Position = UDim2.new(0.1, 0, 0.4, 0)
JumpButton.Size = UDim2.new(0.3, 0, 0, 40)
JumpButton.Font = Enum.Font.GothamBold
JumpButton.Text = "Infinite Jumps"
...
-- Текст "Scripts" справа сверху
local ScriptsLabel = Instance.new("TextLabel")
ScriptsLabel.Name = "ScriptsLabel"
ScriptsLabel.Parent = ExecutorGui
ScriptsLabel.BackgroundTransparency = 1
ScriptsLabel.Position = UDim2.new(0.85, -50, 0.1, 10)
ScriptsLabel.Size = UDim2.new(0, 100, 0, 30)
ScriptsLabel.Font = Enum.Font.GothamBold
ScriptsLabel.Text = "Scripts"
ScriptsLabel.TextColor3 = Color3.fromRGB(200, 150, 255)
ScriptsLabel.TextSize = 24
ScriptsLabel.TextStrokeTransparency = 0.6

-- Кнопка сворачивания ScriptsGui
local ScriptsMinimizeButton = Instance.new("TextButton")
ScriptsMinimizeButton.Name = "ScriptsMinimizeButton"
ScriptsMinimizeButton.Parent = ExecutorGui
ScriptsMinimizeButton.BackgroundColor3 = Color3.fromRGB(150, 150, 150)
ScriptsMinimizeButton.Position = UDim2.new(0.85, -25, 0.15, 10)
ScriptsMinimizeButton.Size = UDim2.new(0, 25, 0, 25)
ScriptsMinimizeButton.Font = Enum.Font.GothamBold
ScriptsMinimizeButton.Text = "-"
ScriptsMinimizeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
ScriptsMinimizeButton.TextSize = 16
ScriptsMinimizeButton.Visible = false
local ScriptsMinimizeCorner = Instance.new("UICorner")
ScriptsMinimizeCorner.CornerRadius = UDim.new(0, 8)
ScriptsMinimizeCorner.Parent = ScriptsMinimizeButton
...
ScriptsCloseButton.MouseEnter:Connect(function() tweenButton(ScriptsCloseButton, UDim2.new(0, 27, 0, 27)) end)
ScriptsCloseButton.MouseLeave:Connect(function() resetButton(ScriptsCloseButton, UDim2.new(0, 25, 0, 25)) end)
ScriptsCloseButton.MouseButton1Down:Connect(function() pressButton(ScriptsCloseButton) end)

WallhackButton.MouseEnter:Connect(function() tweenButton(WallhackButton, UDim2.new(0.32, 0, 0, 42)) end)
WallhackButton.MouseLeave:Connect(function() resetButton(WallhackButton, UDim2.new(0.3, 0, 0, 40)) end)
WallhackButton.MouseButton1Down:Connect(function() pressButton(WallhackButton) end)

SpeedButton.MouseEnter:Connect(function() tweenButton(SpeedButton, UDim2.new(0.32, 0, 0, 42)) end)
SpeedButton.MouseLeave:Connect(function() resetButton(SpeedButton, UDim2.new(0.3, 0, 0, 40)) end)
SpeedButton.MouseButton1Down:Connect(function() pressButton(SpeedButton) end)

JumpButton.MouseEnter:Connect(function() tweenButton(JumpButton, UDim2.new(0.32, 0, 0, 42)) end)
JumpButton.MouseLeave:Connect(function() resetButton(JumpButton, UDim2.new(0.3, 0, 0, 40)) end)
JumpButton.MouseButton1Down:Connect(function() pressButton(JumpButton) end)

ScriptsMinimizeButton.MouseEnter:Connect(function() tweenButton(ScriptsMinimizeButton, UDim2.new(0, 27, 0, 27)) end)
ScriptsMinimizeButton.MouseLeave:Connect(function() resetButton(ScriptsMinimizeButton, UDim2.new(0, 25, 0, 25)) end)
ScriptsMinimizeButton.MouseButton1Down:Connect(function() pressButton(ScriptsMinimizeButton) end)
...
ScriptsButton.MouseButton1Click:Connect(function()
    MainFrame.Visible = false
    ScriptsGui.Visible = true
end)

WallhackButton.MouseButton1Click:Connect(function()
    CodeInput.Text = [[local Players = game:GetService("Players")
    local LocalPlayer = Players.LocalPlayer
...
SpeedButton.MouseButton1Click:Connect(function()
    CodeInput.Text = [[game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 100]]
    ScriptsGui.Visible = false
    MainFrame.Visible = true
    StatusCircle.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Зеленый
end)
...
JumpButton.MouseButton1Click:Connect(function()
    CodeInput.Text = [[local UserInputService = game:GetService("UserInputService")
...
ScriptsCloseButton.MouseButton1Click:Connect(function()
    ScriptsGui.Visible = false
    MainFrame.Visible = true
end)

ScriptsMinimizeButton.MouseButton1Click:Connect(function()
    ScriptsGui.Visible = false
    ScriptsMinimizeButton.Visible = false
    ScriptsLabel.Visible = true
end)

ScriptsLabel.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        ScriptsGui.Visible = true
        ScriptsMinimizeButton.Visible = true
        ScriptsLabel.Visible = false
    end
end)
